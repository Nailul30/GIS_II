package com.aerm.myapplication;
...
import com.aerm.myapplication.databinding.ActivityMapsBinding;
...
//        Custom Size Marker
        int tinggi = 100;
        int lebar = 90;
        BitmapDrawable bitmapStart = (BitmapDrawable)getResources().getDrawable(R.drawable.pin_marker_hitam);
        BitmapDrawable bitmapDes = (BitmapDrawable)getResources().getDrawable(R.drawable.pin_marker_merah);
        ...
        mMap.addMarker(new MarkerOptions().position(sma5).title("Marker in SMA NEGERI 5 PALU")
